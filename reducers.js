...
function modal(state = initialState4, action) {
  switch (action.type) {
    case OPEN_MODAL:
      return {
        ...state,
...
function usersLikes(state = initialState5, action) {
  switch (action.type) {
    case FETCHING_LIKES:
      return {
        ...state,
...
function likeCount(state = initialState6, action) {
  switch (action.type) {
    case FETCHING_COUNT:
      return {
        ...state,
...
function usersDucks(state = initialState7, action) {
  switch (action.type) {
...
function replies(state = initialState8, action) {
  switch (action.type) {
